  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="flex flex-col items-center justify-center px-6 pt-20 pb-8 md:pt-28 md:pb-10 text-center">
        ...
        <p className="text-base text-muted-foreground max-w-4xl mb-6 leading-relaxed">
        ...
        <p className="text-[11px] text-muted-foreground/90 max-w-md mb-8 leading-relaxed">
        ...
        <p className="mt-5 text-xs text-muted-foreground">
          Already have an account? <Link to="/auth" className="text-primary font-medium hover:underline transition-colors">Log in here</Link><span className="text-muted-foreground">.</span>
        </p>
      </section>
      ...
      <section className="px-6 pb-10 md:pb-14">
        <div className="max-w-[700px] mx-auto p-[2px] rounded-2xl bg-gradient-to-r from-[hsl(340,72%,65%)] via-[hsl(278,52%,50%)] to-[hsl(220,62%,55%)]">
          <div className="rounded-[calc(1rem-2px)] bg-[hsl(278,30%,98%)] px-8 py-6 text-center">
